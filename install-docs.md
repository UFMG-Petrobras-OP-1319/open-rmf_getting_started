...
6. **Auto-activation**:
    - pyautoenv is automatically installed, so the project environment is 
    automatically activated by pyautoenv when you `cd` into the root and
    deactivate when leaving the project folder.
