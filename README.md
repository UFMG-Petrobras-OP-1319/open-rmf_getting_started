...
> If you installed the Open-RMF from source following the source install section, you can skip the traffic editor installation because they already come together with the source code.
